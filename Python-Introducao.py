...
# Ex 8 : Diga duas notas de um aluno, calcule a média e diga se ele for aprovado ou esta de recuperação(<7)
...
# Ex 8 : Diga duas notas de um aluno, calcule a média e diga se ele for aprovado(media>=7) ou esta de recuperação(4<=media<7) ou reprovado(media<4)
nota1 = float(input("Digite a primeira nota:"))
nota2 = float(input("Digite a segunda nota:"))
...
# Ex 10: Leia uma idade do teclado e se for maior que 100 ou menor que 0, diga que é invalido e pergunte novamente
...
# Ex12: Diga quantas vezes o computador deve escrever Infinity School na tela
contador = 0
...
# Ex14: Defina um usuario e senha e peça pro usuario digitar permita o login apenas se for igual
